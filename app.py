...
# Main title
st.title("🔍 Semantic Search App - Example Demonstrations")
st.divider()

# -------------------------- Example 1: Food & Cooking Deep Dive --------------------------
st.header("Example 1: The 'Food & Cooking' Deep Dive")
st.subheader("Core Goal", divider="gray")
st.write("Use this text to show that searching for a cultural vibe or a feeling works better than searching for specific ingredients.")
...
st.code(food_text, language="text")

st.subheader("Semantic Query Pairs", divider="gray")
...
st.header("Example 2: The 'Java' Challenge")
st.subheader("Input Text", divider="gray")
...
st.code(java_text, language="text")
...
st.code(java_short_text, language="text")

st.subheader("Test Scenario", divider="gray")
st.markdown("""
